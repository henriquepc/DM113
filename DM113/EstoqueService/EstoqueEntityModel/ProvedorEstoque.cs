namespace EstoqueEntityModel
{
    ...
    {
        public int Id { get; set; } //NÃO DEVE PERMITIR NULO
        public string NumeroProduto { get; set; }//NÃO DEVE PERMITIR NULO
        public string NomeProduto { get; set; }//NÃO DEVE PERMITIR NULO
        public string DescricaoProduto { get; set; }
        public int EstoqueProduto { get; set; }//NÃO DEVE PERMITIR NULOZ
    }
}